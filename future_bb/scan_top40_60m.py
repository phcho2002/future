#!/usr/bin/env python3
"""future_bb 突破系统 — 全品种扫描 (akshare 60m)

读取 futures_top40.json 品种池，使用 akshare 获取小时线数据，
...
def get_60m_data(symbol, use_cache=True):
    """获取60分钟K线数据"""
    cache_path = _HERE / "cache" / f"{symbol}_minute_60.pkl"
